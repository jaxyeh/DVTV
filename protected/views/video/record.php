...
<tr>
	<td valign="middle" align="center">
		<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
			...
			<param name="movie" value="../swf/VideoRecorder.swf?userId=<?php echo $userId; ?>&
			qualityurl=avcQuality&recorderId=<?php echo $recordId; ?>" />
			<param name="quality" value="high" />
			<param name="bgcolor" value="#333333" />
			<param name="allowScriptAccess" value="sameDomain" />
			<embed src="../swf/VideoRecorder.swf?userId=<?php echo $userId; ?>&
			qualityurl=avcQuality&recorderId=<?php echo $recordId; ?>" quality="high" bgcolor="#333333"
